          ...
          <form action={action}>
            <div className="grid gap-4">
              <div className="grid gap-2">
                ...
                <Input id="name" type="text" name="name" placeholder="Max Verstappen" required />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="email">Email</Label>
                <Input id="email" type="email" name="email" placeholder="mverstappen@example.com" required />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="address">Address</Label>
                <Input id="address" type="text" name="address" placeholder="1234 Main St" required />
              </div>
              <div className="grid gap-2">
