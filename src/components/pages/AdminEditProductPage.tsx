...
export default function AdminEditProductPage({ product }: { product: Product }) {
  ...
  return (
    <>
      <form action={action} id="editProductForm">
        <div
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="hidden items-center gap-2 md:ml-auto md:flex">
              ...
              <Button type="button" size="sm" disabled={pending} onClick={() => setIsAlertDialogOpen(true)}>
                {pending ? (
                  <>
          ...
          <div className="flex items-center justify-between gap-2 md:hidden">
            ...
            <Button type="button" className="w-full" disabled={pending} onClick={() => setIsAlertDialogOpen(true)}>
              {pending ? (
                <>
                  <Loader2 className="animate-spin size-4 mr-2" />
                  Please wait
      ...
      <AlertDialog open={isAlertDialogOpen} onOpenChange={setIsAlertDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently edit this product and save to database.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction form="editProductForm" type="submit">
              Continue
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
